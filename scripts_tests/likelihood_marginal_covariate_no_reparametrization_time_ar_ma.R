...
write.table(emv,"likelihood_marginal_covariate_no_reparametrization_time_ar_ma.txt",col.names = T)
emv.results = read.table("likelihood_marginal_covariate_no_reparametrization_time_ar_ma.txt")
alpha.real = .75
