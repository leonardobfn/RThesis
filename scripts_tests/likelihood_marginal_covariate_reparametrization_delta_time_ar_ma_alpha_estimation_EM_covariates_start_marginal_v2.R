...
write.table(emv.results,"likelihood_marginal_covariate_reparametrization_delta_time_ar_ma_alpha_estimation_EM_covariates_start_marginal_v2_teste3.txt",col.names = T)
#Analysis-------
rm(list = ls())
number_of_years = c(5, 10, 15,20, 25)
...
theta.real <- c(betas.real,
                ...
                ma.real,
                alpha.real)
emv.results = read.table("likelihood_marginal_covariate_reparametrization_delta_time_ar_ma_alpha_estimation_EM_covariates_start_marginal_v2_teste3.txt")
